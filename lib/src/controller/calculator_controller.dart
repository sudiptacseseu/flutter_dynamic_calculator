...
class CalculatorController extends ChangeNotifier {
  ...
  /// Create a [CalculatorController] with [maximumDigits] is 10 and maximumFractionDigits of [numberFormat] is 6.
  CalculatorController({maximumDigits = 10})
      : _calc = Calculator(maximumDigits: maximumDigits);

  /// Create a [Calculator].
  CalculatorController.numberFormat(
      intl.NumberFormat numberFormat, int maximumDigits)
  ...
  /// Add double zero to the display.
  void addDoubleZero(int num) {
    _calc.addDigit(num);
    _calc.addDigit(num);
    _acLabel = 'C';
    notifyListeners();
